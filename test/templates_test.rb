...
class TemplatesTest < Test::Unit::TestCase
  ...
  it 'loads templates from source file with slurp_file_templates' do
    mock_app {
      slurp_file_templates
    }
  ...
  test 'slurp_file_templates simply ignores IO errors' do
    assert_nothing_raised {
      mock_app {
        slurp_file_templates('/foo/bar')
      }
    }
